...
Pour la liste d'actualités : 
Mettre des étoiles selon la qualité de l'article

Détails articles:
Créer un bloc de commentaires avec des likes selon si le commentaire est utile ou non
Si le membre n'est pas connecté : il ne peut pas "voter"
"x internautes ont trouvé ce commentaire utile" : l'afficher en dehors de la condition if(isset($_SESSION['id']))
...
Se souvenir de moi : voir pour la connexion